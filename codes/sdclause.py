...
# Form implementation generated from reading ui file 'sdclause.ui'
#
...
class Ui_sdclause(QWidget):
    dbname=""
    sdclause=None
    def setupUi(self, sdclause,dbname):
        sdclause.setObjectName("sdclause")
        sdclause.resize(454, 212)
        sdclause.setStyleSheet("background-color: rgb(255, 255, 191);")
        self.centralwidget = QtWidgets.QWidget(sdclause)
...
"font: 10pt \"Comic Sans MS\";")
        ...
        sdclause.setCentralWidget(self.centralwidget)

        self.retranslateUi(sdclause)
        QtCore.QMetaObject.connectSlotsByName(sdclause)
        sdclause.setFixedSize(454,212)



        self.sdclause=sdclause
        self.dbname=dbname
    ...
    def executeevent(self):
        ...
        if we=="":
            ...
            query="SELECT DISTINCT "+se+" FROM "+fe+" WHERE "+we+";"
    ...
    def retranslateUi(self, sdclause):
        _translate = QtCore.QCoreApplication.translate
        sdclause.setWindowTitle(_translate("sdclause", "DISTINCT"))
        self.label_2.setText(_translate("sdclause", "FROM"))
        self.label_3.setText(_translate("sdclause", "WHERE"))
        self.label.setText(_translate("sdclause", "SELECT DISTINCT"))
        self.execute.setText(_translate("sdclause", "Execute"))
        self.reset.setText(_translate("sdclause", "Reset"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    sdclause = QtWidgets.QMainWindow()
    ui = Ui_sdclause()
    ui.setupUi(sdclause)
    sdclause.show()
    sys.exit(app.exec_())
